...
export const Navbar = () => {
  return (
    <div className="mx-auto my-5 flex w-full max-w-6xl justify-between">
      <a href="#">
        <svg
          fill="none"
      ...
      <div className="flex items-center gap-5 text-neutral-200">
        <a href="#">Blog</a>
        <button className="relative cursor-pointer rounded-xl border border-neutral-700 bg-black px-4 py-2 text-neutral-300">
